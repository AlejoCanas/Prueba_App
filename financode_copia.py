...
if seleccion == "Inicio":
    ...
    if st.session_state.perfil is None:
        ...
        # 3. Inversión inicial, Periodo y Frecuencia (implícita)
        st.subheader("3. Configuración de Simulación")

        sim_col1, sim_col2 = st.columns(2)

        with sim_col1:
            # 3.a. Inversión inicial
            ...
            if not tickers:
                ...
                with st.spinner("Descargando datos y calculando métricas..."):
                    ...
                    def calculate_beta(asset_returns, benchmark_returns):
                        ...
                        # Alineamos los índices por si acaso
                    ...
                    try:
                        ...
                        # --- REQ 4: RESULTADOS MÍNIMOS (MÉTRICAS) ---
